...
namespace Antiaris.NPCs.Enemies
{
    public class RedPixie : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            bannerItem = mod.ItemType("RedPixieBanner");
            banner = npc.type;
        }
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Красная пикси");
            DisplayName.AddTranslation(GameCulture.Chinese, "红色小精灵");
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(npc.position, npc.width, npc.height, 60, 0.0f, 0.0f, 200, default(Color), 1.0f);
            ...
            if (this.spawning < 3)
                ...
                {
                    this.spawning++;
                    NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("RedPetitePixie"), 0, 0.0f, (float)npc.whoAmI, 0.0f, 0.0f, 255);
                }
                ...
                if (!moon)
                {
                    ...
                    else
                    {
                        ...
                        foreach (NPC npc1 in Main.npc)
                            if (npc1.active && npc1.type == mod.NPCType("RedPetitePixie"))
                            {
        ...
        {
            if (Main.rand.Next(2) == 0)
                Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("RedBigCrystal"), Main.rand.Next(1, 3), false, 0, false, false);
        }
