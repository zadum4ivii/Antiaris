...
namespace Antiaris.NPCs.Enemies
{
    public class RedPetitePixie : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Красная маленькая пикси");
            DisplayName.AddTranslation(GameCulture.Chinese, "红色迷你精灵");
        ...
        public override void AI()
        {
            ...
            if (Main.npc[ai1].active)
            {
                ...
                if (Main.npc[ai1].oldPos[1] != Vector2.Zero && Main.npc[ai1].type == mod.NPCType("RedPixie"))
                {
