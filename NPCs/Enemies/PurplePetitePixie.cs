...
namespace Antiaris.NPCs.Enemies
{
    public class PurplePetitePixie : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Фиолетовая маленькая пикси");
            DisplayName.AddTranslation(GameCulture.Chinese, "紫色迷你精灵");
        ...
        public override void AI()
        {
            ...
            if (Main.npc[ai1].active)
            {
                ...
                if (Main.npc[ai1].oldPos[1] != Vector2.Zero && Main.npc[ai1].type == mod.NPCType("PurplePixie"))
                {
