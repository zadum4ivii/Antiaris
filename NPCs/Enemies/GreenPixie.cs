...
namespace Antiaris.NPCs.Enemies
{
    public class GreenPixie : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            bannerItem = mod.ItemType("GreenPixieBanner");
            banner = npc.type;
        }
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Зелёная пикси");
            DisplayName.AddTranslation(GameCulture.Chinese, "绿色小精灵");
        ...
        public override void AI()
        {
            ...
            if (this.spawning < 3)
                ...
                {
                    this.spawning++;
                    NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("GreenPetitePixie"), 0, 0.0f, (float)npc.whoAmI, 0.0f, 0.0f, 255);
                }
                ...
                if (!moon)
                {
                    ...
                    else
                    {
                        ...
                        foreach (NPC npc1 in Main.npc)
                            if (npc1.active && npc1.type == mod.NPCType("GreenPetitePixie"))
                            {
        ...
        {
            if (Main.rand.Next(2) == 0)
                Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("GreenBigCrystal"), Main.rand.Next(1, 3), false, 0, false, false);
        }
