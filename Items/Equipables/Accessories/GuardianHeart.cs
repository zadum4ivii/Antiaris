    ...
    public class GuardianHeart : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            if ((double)timer >= 480.0)
            {
                ...
                player.AddBuff(mod.BuffType("Amplification"), 600, true);
                player.AddBuff(mod.BuffType("BloodRepletion"), Main.rand.Next(4400, 5200), true);
            }
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "BloodyChargedCrystal", 17);
