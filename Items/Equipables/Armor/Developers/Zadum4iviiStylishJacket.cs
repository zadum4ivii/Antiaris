...
namespace Antiaris.Items.Equipables.Armor.Developers
{
    ...
    public class Zadum4iviiStylishJacket : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Zadum4ivii's Stylish Jacket");
            Tooltip.SetDefault("'Great for impersonating devs!'");
            DisplayName.AddTranslation(GameCulture.Russian, "Стильный пиджак Zadum4ivii");
            Tooltip.AddTranslation(GameCulture.Russian, "'Поможет вам выдать себя за разработчика!'");
			DisplayName.AddTranslation(GameCulture.Chinese, "Zadum4ivii时尚夹克");
