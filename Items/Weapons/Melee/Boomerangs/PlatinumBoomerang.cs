...
namespace Antiaris.Items.Weapons.Melee.Boomerangs
{
    public class PlatinumBoomerang : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.useStyle = 1;
            item.knockBack = 3f;
            item.shoot = mod.ProjectileType("PlatinumBoomerang");
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Chinese, "铂金回旋镖");
            Tooltip.AddTranslation(GameCulture.Chinese, "对附近的敌人发射魔法火花");
            DisplayName.AddTranslation(GameCulture.Russian, "Платиновый бумеранг");
