...
namespace Antiaris.Items.Weapons.Ranged.Flamethrowers
{
    public class IchorFlamethrower : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("IchorFlames");
            item.shootSpeed = 8f;
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Chinese, "脓血喷火器");
            DisplayName.AddTranslation(GameCulture.Russian, "Ихоровый огнемёт");
        }
