...
namespace Antiaris.Items.Consumables.Bags
{
    public class TowerKeeperTreasureBag2 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.rare = 9;
			item.expert = true;
			bossBagNPC = mod.NPCType("TowerKeeper2");
        }
		...
		public override void OpenBossBag(Player player)
        {
			...
			player.QuickSpawnItem(mod.ItemType("ShadowChargedCrystal"), Main.rand.Next(15,24));
			...
			if (Main.rand.Next(7) == 0)
            {
                player.QuickSpawnItem(mod.ItemType("GuardianHeart2"));
            }				
        }
	}
}