...
namespace Antiaris.Items.Consumables.Potions
{
    public class ChilledLeafRoll : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Chinese, "寒冰叶卷");
            Tooltip.AddTranslation(GameCulture.Chinese, "1、10 秒内每秒可以恢复 1 点体力\n2、能够使用 5 次\n3、使你对岩浆免疫");
            DisplayName.AddTranslation(GameCulture.Russian, "Рулон замёрзших листьев");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "ChilledLeaf", 10);
