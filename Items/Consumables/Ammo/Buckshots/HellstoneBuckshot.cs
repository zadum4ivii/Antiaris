...
namespace Antiaris.Items.Consumables.Ammo.Buckshots
{
    public class HellstoneBuckshot : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Chinese, "狱炎石火铳弹");
            Tooltip.AddTranslation(GameCulture.Chinese, "用于火铳");
            DisplayName.AddTranslation(GameCulture.Russian, "Картечь из адского камня");
        ...
        {
            type = mod.ProjectileType("HellstoneBuckshot");
        }
