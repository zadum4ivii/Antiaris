...
namespace Antiaris.Tiles.Decorations
{
	public class BorealWoodCabinet : ModTile
	{
	    public override void SetDefaults()
		{
            ...
            name.AddTranslation(GameCulture.Russian, "Шкаф из северной древесины");
            name.AddTranslation(GameCulture.Chinese, "北地木柜橱");
            AddMapEntry(new Color(191, 142, 111), name);
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Containers };
			chest = "Boreal Wood Cabinet";
			chestDrop = mod.ItemType("BorealWoodCabinet");
		}
	    ...
	    public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				player.showItemIcon2 = mod.ItemType("BorealWoodCabinet");
			}
			player.noThrow = 2;
