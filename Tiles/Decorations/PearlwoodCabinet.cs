...
namespace Antiaris.Tiles.Decorations
{
	public class PearlwoodCabinet : ModTile
	{
	    public override void SetDefaults()
		{
            ...
            name.AddTranslation(GameCulture.Russian, "Шкаф из жемчужной древесины");
            name.AddTranslation(GameCulture.Chinese, "珍珠木柜橱");
            AddMapEntry(new Color(191, 142, 111), name);
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Containers };
			chest = "Pearlwood Cabinet";
			chestDrop = mod.ItemType("PearlwoodCabinet");
		}
	    ...
	    public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				player.showItemIcon2 = mod.ItemType("PearlwoodCabinet");
			}
			player.noThrow = 2;
