...
namespace Antiaris.Tiles.Decorations
{
	public class Cabinet : ModTile
	{
	    public override void SetDefaults()
		{
            ...
            name.AddTranslation(GameCulture.Russian, "Шкаф");
            name.AddTranslation(GameCulture.Chinese, "柜橱");
            AddMapEntry(new Color(191, 142, 111), name);
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Containers };
			chest = "Cabinet";
			chestDrop = mod.ItemType("Cabinet");
		}
	    ...
	    public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				player.showItemIcon2 = mod.ItemType("Cabinet");
			}
			player.noThrow = 2;
