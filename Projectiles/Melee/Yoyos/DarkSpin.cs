...
namespace Antiaris.Projectiles.Melee.Yoyos
{
	class DarkSpin : ModProjectile
	{
	    ...
	    public override void SetStaticDefaults()
		{
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Темное вращение");
		}
	    ...
	    public override void AI()
        {
            ...
            if (!this.spawned)
            {
                ...
                for (int count = 0; count < 10; count++)
                {
                    ...
                    Projectile.NewProjectile((int)spawn.X, (int)spawn.Y, 0.0f, 0.0f, mod.ProjectileType("DarkBall"), projectile.damage, projectile.knockBack, 0, (float)projectile.whoAmI, (float)count);
                }
            }
        }
	}
