...
namespace Antiaris.Projectiles.Ranged.Buckshots
{
    public class IchorBuckshot : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Chinese, "脓血火铳弹");
            DisplayName.AddTranslation(GameCulture.Russian, "Ихоровая картечь");
        }
        ...
        { 
			...
			damage = damage + (int)Main.CalculateDamage(damage, target.defense);
