...
namespace Antiaris.Projectiles.Ranged.Buckshots
{
    public class CrystalBuckshot : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
			...
			DisplayName.AddTranslation(GameCulture.Chinese, "水晶火铳弹");
        ...
        {
            for (int k = 0; k < 8; k++) Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 90, projectile.oldVelocity.X * 0.2f, projectile.oldVelocity.Y * 0.2f);
