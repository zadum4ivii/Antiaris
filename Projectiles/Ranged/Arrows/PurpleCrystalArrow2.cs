...
namespace Antiaris.Projectiles.Ranged.Arrows
{
    ...
    {
        public override void PostDraw(SpriteBatch spriteBatch, Color lightColor) { AntiarisUtils.DrawProjectileGlowMaskWorld(spriteBatch, projectile, mod.GetTexture("Glow/PurpleCrystalArrow_GlowMask2"), projectile.rotation, projectile.scale); }
