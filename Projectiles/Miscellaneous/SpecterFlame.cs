...
namespace Antiaris.Projectiles.Miscellaneous
{
    public class SpecterFlame : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Пламя спектра");
            DisplayName.AddTranslation(GameCulture.Chinese, "虹彩火焰");
        ...
        public override void AI()
        {
            ...
            if (player.active && ((double)Vector2.Distance(player.Center, projectile.Center) < 25.0))
            {
                ...
                {
                    case 0:
                        player.AddBuff(mod.BuffType("SapphireEssence"), 180, true);
                        break;
                    case 1:
                        player.AddBuff(mod.BuffType("DiamondEssence"), 180, true);
                        break;
                    case 2:
                        player.AddBuff(mod.BuffType("AmethystEssence"), 180, true);
                        break;
                    case 3:
                        player.AddBuff(mod.BuffType("TopazEssence"), 180, true);
                        break;
                    case 4:
                        player.AddBuff(mod.BuffType("EmeraldEssence"), 180, true);
                        break;
                    case 5:
                        player.AddBuff(mod.BuffType("RubyEssence"), 180, true);
                        break;
                }
                projectile.Kill();
            }
