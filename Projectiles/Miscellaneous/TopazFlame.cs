...
namespace Antiaris.Projectiles.Miscellaneous
{
    public class TopazFlame : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Топазовое пламя");
            DisplayName.AddTranslation(GameCulture.Chinese, "黄玉火焰");
        ...
        public override void AI()
        {
            ...
            {
                player.AddBuff(mod.BuffType("TopazEssence"), 300, true);
                projectile.Kill();
            }
            float ai2 = 0.5f;
