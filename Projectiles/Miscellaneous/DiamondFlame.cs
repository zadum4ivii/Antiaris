...
namespace Antiaris.Projectiles.Miscellaneous
{
    public class DiamondFlame : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Алмазное пламя");
            DisplayName.AddTranslation(GameCulture.Chinese, "钻石火焰");
        ...
        public override void AI()
        {
            ...
            {
                player.AddBuff(mod.BuffType("DiamondEssence"), 300, true);
                projectile.Kill();
            }
            float ai2 = 0.5f;
