...
namespace Antiaris.Projectiles.Miscellaneous
{
    public class SapphireFlame : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Сапфировое пламя");
            DisplayName.AddTranslation(GameCulture.Chinese, "蓝宝石火焰");
        ...
        public override void AI()
        {
            ...
            {
                player.AddBuff(mod.BuffType("SapphireEssence"), 300, true);
                projectile.Kill();
            }
            float ai2 = 0.5f;
