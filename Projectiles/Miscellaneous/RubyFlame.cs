...
namespace Antiaris.Projectiles.Miscellaneous
{
    public class RubyFlame : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Рубиновое пламя");
            DisplayName.AddTranslation(GameCulture.Chinese, "红宝石火焰");
        ...
        public override void AI()
        {
            ...
            {
                player.AddBuff(mod.BuffType("RubyEssence"), 300, true);
                projectile.Kill();
            }
            float ai2 = 0.5f;
