...
namespace Antiaris.Projectiles.Miscellaneous
{
    public class AmethystFlame : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.Russian, "Аметистовое пламя");
            DisplayName.AddTranslation(GameCulture.Chinese, "紫水晶火焰");
        ...
        public override void AI()
        {
            ...
            {
                player.AddBuff(mod.BuffType("AmethystEssence"), 300, true);
                projectile.Kill();
            }
            float ai2 = 0.5f;
