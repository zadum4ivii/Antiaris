...
namespace Antiaris.Projectiles.Thrown
{
    public class CarapaceDagger : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
			...
			int item = Main.rand.Next(3) == 0 ? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("CarapaceDagger"), 1, false, 0, false, false) : 0;
